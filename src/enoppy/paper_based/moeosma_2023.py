...
# --------------------------------------------------%
"""Engineering problems from the MOEOSMA 2023 paper."""
...
class SpeedReducerProblem(Engineer):
    ...
    def get_objs(self, x):
        ...
        f1 = (
            0.7854 * x[0] * x[1] ** 2 * (14.9334 * x[2] + 3.3333 * x[2] ** 2 - 43.0934)
...
class HydrostaticThrustBearingProblem(Engineer):
    ...
    def __init__(self, f_penalty=None):
        ...
        self.C1 = 10.04
        self.n = -3.55
        self._bounds = [(1.0, 16.0), (1.0, 16.0), (1e-6, 16e-6), (1.0, 16.0)]
        self.check_penalty_func(f_penalty)
...
class BulkCarriersProblem(Engineer):
    ...
    def __init__(self, f_penalty=None):
        ...
        self._n_objs = 3
        self._n_cons = 9
        self._bounds = [(150, 274.32), (20, 32.31), (13, 25), (10, 11.71), (14.0, 18.0), (0.63, 0.75)]
        self.check_penalty_func(f_penalty)
    ...
    def get_objs(self, x):
        ...
        P = (1.025 * L * B * T * CB) ** (2.0 / 3) * Vk**3 / (a + b * Fn)
        Wm = 0.17 * P**0.9
        Wls = Ws + Wo + Wm
